...
## Step 3
Run the python file. You can do this in several different ways. It is assumed you know how to run a python file. If not, ask a search engine, artificial intelligence, or your nerd friend.
